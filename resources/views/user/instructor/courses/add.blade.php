                                  ...
                                  <div class="tab-content" id="v-pills-tabContent">
                                    <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror textarea" cols="30" rows="10" required autocompleted="description"  >{{ old('description') }}</textarea>
                                    ...
                                    <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <textarea name="faq" id="faq" class="form-control @error('faq') is-invalid @enderror textarea" cols="30" rows="10" required autocompleted="faq"  >{{ old('faq') }}</textarea>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <textarea name="what_will_students_learn" id="what_will_students_learn" class="form-control @error('what_will_students_learn') is-invalid @enderror textarea" cols="30" rows="10" required autocompleted="what_will_students_learn"  >{{ old('what_will_students_learn') }}</textarea>
                                    ...
                                    <div class="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <textarea name="target_students" id="target_students" class="form-control @error('target_students') is-invalid @enderror textarea" cols="30" rows="10" required autocompleted="target_students"  >{{ old('target_students') }}</textarea>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <textarea name="requirements" id="requirements" class="form-control @error('requirements') is-invalid @enderror textarea" cols="30" rows="10" required autocompleted="requirements"  >{{ old('requirements') }}</textarea>

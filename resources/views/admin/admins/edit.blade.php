                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admins.update', $admin->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror textarea" cols="30" rows="10" required autocompleted="description">{{ $admin->description }}</textarea>
